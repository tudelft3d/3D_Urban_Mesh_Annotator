...
namespace CGAL{
		  ...
		  bool /* verbose */ = false)
  {
	  ...
	  //add total label faces
	  out << "comment MyFaces " << total_labeled_faces << std::endl;
	  ...
	  if (comments != NULL)
	  {
		  ...
		  {
			  QString temp_line = line.data();
			  temp_line = temp_line.left(temp_line.lastIndexOf(" "));
			  if ((temp_line == "TextureFile" && has_texture) ||
				  temp_line == "MyFaces")// Avoid repeating the line if multiple savings
				  continue;
