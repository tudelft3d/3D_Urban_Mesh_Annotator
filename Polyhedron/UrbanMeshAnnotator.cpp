...
UrbanMeshAnnotator::UrbanMeshAnnotator(int &argc, char **argv,
...
UrbanMeshAnnotator::~UrbanMeshAnnotator() {}

void UrbanMeshAnnotator::do_not_catch_exceptions() {
    d_ptr->catch_exceptions = false;
    setProperty("no-try-catch", true);
}

bool UrbanMeshAnnotator::notify(QObject *receiver, QEvent *event) {
...
int UrbanMeshAnnotator::try_exec() {
