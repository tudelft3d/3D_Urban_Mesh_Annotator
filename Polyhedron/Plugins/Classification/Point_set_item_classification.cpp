...
//***********************Ziqian*******************************//
void Point_set_item_classification::threshold_based_change_color(int index, int threshold, bool below, float* vmin, float* vmax) {}

bool Point_set_item_classification::can_show_probability() {
	std::cout << "cluster haven't been implemented." << std::endl;
	return false;
}
//************************************************************//
