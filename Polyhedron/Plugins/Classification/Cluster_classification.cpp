...
//***********************Ziqian*******************************//
void Cluster_classification::threshold_based_change_color(int index, int threshold, bool below, float* vmin, float* vmax) {}
bool Cluster_classification::can_show_probability() {
	std::cout << "cluster haven't been implemented." << endl;
	return false;
}
//************************************************************//
 //***********************Weixiao*******************************//
